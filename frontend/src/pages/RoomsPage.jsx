...
const RoomsPage = ({data}) => {
  ...
  return (
    <div>
      <Banner bannerImage={bannerImage} text1="Our Rooms" text2="Nurture. Enjoy. Grow. Flourish." />

      <ul className="roomnav">
        <li><a href="#sajaanroom" onClick={() => setCurrentRoom('Sajaan Room')}>Sajaan Room</a></li>
        <li><a href="#ariaroom" onClick={() => setCurrentRoom('Aria Room')}>Aria Room</a></li>
        <li><a href="#sapphireroom" onClick={() => setCurrentRoom('Sapphire Room')}>Sapphire Room</a></li>
        <li><a href="#irisroom" onClick={() => setCurrentRoom('Iris Room')}>Iris Room</a></li>
        <li><a href="#ameliaroom" onClick={() => setCurrentRoom('Amelia Room')}>Amelia Room</a></li>
        <li><a href="#avusuite" onClick={() => setCurrentRoom('Avu Suite')}>Avu Suite</a></li>
      </ul>
