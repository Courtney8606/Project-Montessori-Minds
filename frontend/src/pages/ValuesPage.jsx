...
const ValuesPage = () => {
  return (
    <div>
      <Banner bannerImage={bannerImage} text1="Our Values" text2="Nurture. Enjoy. Grow. Flourish."/>
      <div>
      ...
      <div className="values">
        ...
        <div className="values-content">
          ...
          <p>
            ...
            access to fun and exciting activities. Our teachers provide natural,
            real life learning experiences, which enable children to learn
            through play and enjoy activities linked to their individual
            interests.
          </p>
        </div>
      </div>
      ...
      <div className="values">
        ...
        <div className="values-content">
          ...
          <p>
            ...
            continually reflecting, improving and learning from those around us,
            including our children; where we strive to consistently achieve the
            best possible outcomes for our children and teachers.
          </p>
        </div>
      </div>
      <hr />
      <div className="values">
        ...
        <div className="values-content">
          ...
          <p>
            Our children are at the forefront of everything we do. We are highly
            passionate in ensuring each child and teacher with us has an
            opportunity to flourish and exceed at Montessori Minds Day Nursery.
            To ensure excellent standards across our curriculum we follow a
            Montessori integrated pedagogy in addition to the Early Years
            Foundation Stage Curriculum as well as many other researched
